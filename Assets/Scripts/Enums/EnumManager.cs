...
public class EnumManager : MonoBehaviour
{
    ...
    // it doesnt execute during the play phase but rather in the unity editor
    ...
    static void UpdatePCsFromAssets()
    {
        ...
        try
        {
            using (StreamWriter streamWriter = new StreamWriter(enumsFilePath, false, Encoding.UTF8))
            {
